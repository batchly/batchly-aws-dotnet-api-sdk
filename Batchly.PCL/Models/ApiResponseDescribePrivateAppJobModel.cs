...
{
    public class ApiResponseDescribePrivateAppJobModel : INotifyPropertyChanged 
    {
        // These fields hold the values for the public properties.
        private string requestId;
        private DescribePrivateAppJobModel data;
        ...
        /// </summary>
        [JsonProperty("Data")]
        public DescribePrivateAppJobModel Data 
        { 
            get 
            {
                return this.data; 
