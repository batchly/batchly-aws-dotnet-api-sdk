...
{
    public class ApiResponseDescribeHadoopStreamingJobModel : INotifyPropertyChanged 
    {
        // These fields hold the values for the public properties.
        private string requestId;
        private DescribeHadoopStreamingJobModel data;
        ...
        /// </summary>
        [JsonProperty("Data")]
        public DescribeHadoopStreamingJobModel Data 
        { 
            get 
            {
                return this.data; 
